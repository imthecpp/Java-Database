...
/**
 * This interface contains methods that are considered the "vendor extension" to the JDBC API for MySQL's implementation of java.sql.ConnectionConfiguration.
 * 
...
public interface Connection extends java.sql.Connection, ConnectionProperties {
     ...
     * with the same semantics as the java.sql.ConnectionConfiguration.prepareStatement()
     ...
     * @deprecated replaced by <code>ConnectionConfiguration.getServerCharset()</code>
     */
    @Deprecated
     ...
     * as the java.sql.ConnectionConfiguration.prepareStatement() method with the
     * same argument types.
     * 
     * @see java.sql.Connection#prepareStatement(String)
     */
