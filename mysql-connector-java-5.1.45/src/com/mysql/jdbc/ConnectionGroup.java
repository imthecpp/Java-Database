...
public class ConnectionGroup {
    ...
    /**
     * Remove the given host (host:port pair) from this ConnectionConfiguration Group.
     * 
     * @param hostPortPair
    ...
    /**
     * Remove the given host (host:port pair) from this ConnectionConfiguration Group and, consequently, from all the load-balanced connections it holds.
     * 
     * @param hostPortPair
     *            The host:port pair to remove.
     * @param removeExisting
    ...
    /**
     * Add the given host (host:port pair) to this ConnectionConfiguration Group.
     * 
     * @param hostPortPair
    ...
    /**
     * Add the given host (host:port pair) to this ConnectionConfiguration Group and, consequently, to all the load-balanced connections it holds.
     * 
     * @param hostPortPair
     *            The host:port pair to add.
     * @param forExisting
