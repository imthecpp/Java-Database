...
/**
 * A ConnectionConfiguration represents a session with a specific database. Within the context of a ConnectionConfiguration, SQL statements are executed and results are returned.
 * 
 * <P>
 * A ConnectionConfiguration's database is able to provide information describing its tables, its supported SQL grammar, its stored procedures, the capabilities of this
...
public class ConnectionImpl extends ConnectionPropertiesImpl implements MySQLConnection {
     ...
     * java.sql.ConnectionConfiguration.TRANSACTION_XXX
     */
    ...
    /** Point of origin where this ConnectionConfiguration was created */
    ...
    /**
     * In some cases, it is desirable to immediately release a ConnectionConfiguration's
     * database and JDBC resources instead of waiting for them to be
     * automatically released (cant think why off the top of my head) <B>Note:</B>
     * A ConnectionConfiguration is automatically closed when it is garbage collected.
     ...
     * by the ConnectionConfiguration. This method should only be used when auto-commit has
     * been disabled.
     * <p>
    ...
    /**
     * Get this ConnectionConfiguration's current transaction isolation mode.
     * 
    ...
    /**
     * The first warning reported by calls on this ConnectionConfiguration is returned.
            ...
            if (this.serverVariables.containsKey("max_allowed_packet")) {
                ...
                if (getUseServerPrepStmts()) {
                    ...
                    if (allowedBlobSendChunkSize <= 0) {
                        throw SQLError.createSQLException(
                                "ConnectionConfiguration setting too low for 'maxAllowedPacket'. "
    ...
    public void realClose(boolean calledExplicitly, boolean issueRollback, boolean skipLocalTeardown, Throwable reason) throws SQLException {
        ...
        try {
            if (!skipLocalTeardown) {
                ...
                if (getUseUsageAdvisor()) {
                    if (!calledExplicitly) {
                        String message = "ConnectionConfiguration implicitly closed by Driver. You should call ConnectionConfiguration.close() from your code to free resources more efficiently and avoid resource leaks.";
                    ...
                    if (connectionLifeTime < 500) {
                        String message = "ConnectionConfiguration lifetime of < .5 seconds. You might be un-necessarily creating short-lived connections and should investigate connection pooling to be more efficient.";
    ...
    /**
     * A sub-space of this ConnectionConfiguration's database may be selected by setting a
