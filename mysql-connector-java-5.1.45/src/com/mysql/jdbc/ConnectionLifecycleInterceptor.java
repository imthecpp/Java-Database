...
public interface ConnectionLifecycleInterceptor extends Extension {
    /**
     * Called when an application calls ConnectionConfiguration.close(), before the driver
    ...
    /**
     * Called when an application calls ConnectionConfiguration.commit(), before the
    ...
    /**
     * Called when an application calls ConnectionConfiguration.rollback(), before the
    ...
    /**
     * Called when an application calls ConnectionConfiguration.setAutoCommit(), before the
    ...
    /**
     * Called when an application calls ConnectionConfiguration.setCatalog(), before the
