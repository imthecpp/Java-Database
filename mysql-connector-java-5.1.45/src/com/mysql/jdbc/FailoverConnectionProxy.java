...
/**
 * A proxy for a dynamic com.mysql.jdbc.ConnectionConfiguration implementation that provides failover features for list of hosts. ConnectionConfiguration switching occurs on
    ...
    private synchronized void connectTo(int hostIndex) throws SQLException {
        try {
            ...
            if (this.currentConnection != null) {
                StringBuilder msg = new StringBuilder("ConnectionConfiguration to ").append(isPrimaryHostIndex(hostIndex) ? "primary" : "secondary").append(" host '")
