 ...
 * 
 * The driver will create an instance for each ConnectionConfiguration instance, and call initialize() once and only once. When the connection is closed, destroy() will be
