...
public abstract class MultiHostConnectionProxy implements InvocationHandler {
    ...
    /**
     * Wraps this object with a new multi-host ConnectionConfiguration instance.
     * 
     * @return
     ...
     * @return
     *         The new ConnectionConfiguration instance.
     */
    ...
    /**
     * Proxies method invocation on the java.sql.ConnectionConfiguration interface, trapping multi-host specific methods and generic methods.
    ...
    public synchronized Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if (METHOD_CLOSE.equals(methodName)) {
            doClose();
            this.isClosed = true;
            this.closedReason = "ConnectionConfiguration explicitly closed.";
