...
/**
 * This class is used by ConnectionConfiguration for communicating with the MySQL server.
 */
public class MysqlIO {
     ...
     * @param conn
     *            the ConnectionConfiguration that is creating us
     * @param socketTimeout
    ...
    // We do this to break the chain between MysqlIO and ConnectionConfiguration, so that we can have PhantomReferences on connections that let the driver clean up the
