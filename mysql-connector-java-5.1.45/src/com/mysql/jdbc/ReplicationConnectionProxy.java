...
/**
 * ConnectionConfiguration that opens two connections, one two a replication master, and another to one or more slaves, and decides to use master when the connection is not
...
public class ReplicationConnectionProxy extends MultiHostConnectionProxy implements PingTarget {
    ...
    /**
     * Creates a proxy for java.sql.ConnectionConfiguration that routes requests to a load-balanced connection of master servers or a load-balanced connection of slave
    ...
    /**
     * Wraps this object with a new replication ConnectionConfiguration instance.
     * 
     * @return
    ...
    /**
     * Proxies method invocation on the java.sql.ConnectionConfiguration interface.
