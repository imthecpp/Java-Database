...
public class StatementImpl implements Statement {
     ...
     * 
     * @param c
     *            the ConnectionConfiguration instance that creates us
     * @param catalog
    ...
    /**
     * JDBC 2.0 Return the ConnectionConfiguration that produced the Statement.
     * 
     * @return the ConnectionConfiguration that produced the Statement
     * 
     * @throws SQLException
     *             if an error occurs
     */
     ...
     * 
     * <p>
     * This gets around the un-threadsafe behavior of "select LAST_INSERT_ID()" which is tied to the ConnectionConfiguration that created this Statement, and therefore could
