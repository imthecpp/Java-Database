...
/**
 * This class serves as a wrapper for the org.gjt.mm.mysql.jdbc2.ConnectionConfiguration class. It is returned to the application server which may wrap it again and then
 * return it to the application client in response to dataSource.getConnection().
 * 
 * All method invocations are forwarded to org.gjt.mm.mysql.jdbc2.ConnectionConfiguration unless the close method was previously called, in which case a sqlException is
