...
public class JDBC4ConnectionWrapper extends ConnectionWrapper {
    ...
    public boolean isWrapperFor(Class<?> iface) throws SQLException {
        ...
        return (iface.getName().equals("com.mysql.jdbc.ConnectionConfiguration") || iface.getName().equals("com.mysql.jdbc.ConnectionProperties"));
    }
    ...
    public synchronized <T> T unwrap(java.lang.Class<T> iface) throws java.sql.SQLException {
        try {
            if ("java.sql.ConnectionConfiguration".equals(iface.getName()) || "java.sql.Wrapper.class".equals(iface.getName())) {
