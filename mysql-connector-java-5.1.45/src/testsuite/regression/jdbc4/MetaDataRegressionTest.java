...
public class MetaDataRegressionTest extends BaseTestCase {
    ...
    public void testBug69298() throws Exception {
        ...
        checkGetFunctionsForBug69298("Std. ConnectionConfiguration MetaData", this.conn);
        checkGetFunctionColumnsForBug69298("Std. ConnectionConfiguration MetaData", this.conn);
        checkGetProceduresForBug69298("Std. ConnectionConfiguration MetaData", this.conn);
        checkGetProcedureColumnsForBug69298("Std. ConnectionConfiguration MetaData", this.conn);
