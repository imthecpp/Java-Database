...
/**
 * Tests java.sql.ConnectionConfiguration functionality
 */
public class ConnectionTest extends BaseTestCase {
    ...
    public void testIsolationLevel() throws Exception {
        if (versionMeetsMinimum(4, 0)) {
            String[] isoLevelNames = new String[] { "ConnectionConfiguration.TRANSACTION_NONE", "ConnectionConfiguration.TRANSACTION_READ_COMMITTED",
                    "ConnectionConfiguration.TRANSACTION_READ_UNCOMMITTED", "ConnectionConfiguration.TRANSACTION_REPEATABLE_READ", "ConnectionConfiguration.TRANSACTION_SERIALIZABLE" };
    ...
    public void testFailoverConnection() throws Exception {
        ...
        if (!isServerRunningOnWindows()) { // windows sockets don't work for this test
            ...
            try {
                ...
                System.out.println("Original ConnectionConfiguration Id = " + originalConnectionId);

                assertTrue("ConnectionConfiguration should not be in READ_ONLY state", !failoverConnection.isReadOnly());
                ...
                System.out.println("new ConnectionConfiguration Id = " + newConnectionId);

                assertTrue("We should have a new connection to the server in this case", !newConnectionId.equals(originalConnectionId));
                assertTrue("ConnectionConfiguration should not be read-only", !failoverConnection.isReadOnly());
            } finally {
    ...
    public void testSelfDestruct() throws Exception {
        ...
        if (!failed) {
            fail("ConnectionConfiguration should've self-destructed");
        }
    ...
    /**
     * IPv6 ConnectionConfiguration test.
     * 
     * @throws SQLException
     */
