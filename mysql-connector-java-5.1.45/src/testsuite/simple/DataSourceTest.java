...
public class DataSourceTest extends BaseTestCase {
    ...
    public void testDataSource() throws Exception {
        ...
        con.close();
        assertTrue("ConnectionConfiguration can not be obtained from data source", con != null);
    }

    /**
     * Tests whether ConnectionConfiguration.changeUser() (and thus pooled connections)
